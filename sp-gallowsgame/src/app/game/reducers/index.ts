...
export const getSelectedLetters = createSelector(getWordState, fromWord.getLetters);

export const getSelectedLetterItem = createSelector(
  getWordState, fromWord.getLetterItem
);
