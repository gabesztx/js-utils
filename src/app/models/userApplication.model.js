...
var UserApplicationModel = /** @class */ (function (_super) {
    __extends(UserApplicationModel, _super);
    function UserApplicationModel(data) {
        var _this = _super.call(this, data) || this;
        _this.application = null;
        _this.externalId = '';
        return _this;
    }
    UserApplicationModel.prototype.serialize = function () {
