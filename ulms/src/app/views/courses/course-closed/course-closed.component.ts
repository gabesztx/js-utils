...
export class CourseClosedComponent implements OnChanges {
    ...
    transFormViewObject(data: RestApiResponse<CourseDetail[]>) {
        ...
        data.items.forEach((value) => {
            ...
            const imageUrl = value.imageUrl.length ? value.imageUrl : 'assets/images/suitcase_big_icon.png';
            ...
            dataArray.push({
                id: activityValue.id,
                imageUrl: value.imageUrl.length ? value.imageUrl : 'assets/images/suitcase_big_icon.png',
